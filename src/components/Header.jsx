    ...
    <header className="sticky top-0 z-50 flex items-center justify-between border-b border-gray-800 bg-black px-4 sm:px-10 lg:px-20 py-3">
      <div className="max-w-6xl w-full mx-auto flex items-center justify-between">
        ...
        <nav className="hidden lg:flex items-center gap-8">
          ...
          <a href="tel:+525611971440" className="ml-4 inline-flex items-center px-4 py-2 bg-amber-400 text-black rounded-lg font-semibold">Llámanos</a>
        </nav>
      ...
      {isMenuOpen && (
        <div className="lg:hidden w-full bg-black border-t border-gray-800">
          <div className="max-w-6xl mx-auto px-4 py-4 flex flex-col gap-3">
            ...
            <a href="tel:+525611971440" onClick={() => setIsMenuOpen(false)} className="mt-2 inline-flex items-center px-4 py-2 bg-amber-400 text-black rounded-lg">Llámanos</a>
          </div>
        </div>
      )}
    </header>
